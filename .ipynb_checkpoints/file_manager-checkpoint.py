...
class FileManager:
    ...
    def _validate_vor_files(self, file_paths, snap_num):
        if not file_paths:
            raise False
    ...
    def vor_file(self, snap_num):
        ...
        return [os.path.join(vor_save_path, f) for f in files_sorted][:self.paths.num_of_vor_file]